---
title: Collapsible Eco Filter
date: 2021-07-25
published: false
cover: ./eco-house.jpg
---

This is a collapsible filter based on a filter I made while working at https://www.ecomadic.com/.<br/>
The look is simple/clean and the UX is intuitive and pleasing.<br/>
The search bar is there just represent the concept of this component and does not do anything.
...
const countryNames = ["Hong Kong", "India", "Indonesia", "Kenya", "Laos", "Malaysia", "Philippines", "United States Of America"];
  ...
  return (
    <div className={"explore-filter"}>
      ...
      <div className={"explore-filter-section"}>
        ...
        {countryChevronState ? (
          <img
            className={"down-outlined turnUp"}
